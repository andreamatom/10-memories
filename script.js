...
const subtitlesData = {
    ...
    "1": [
        ...
        { time: 4.5, sentence: "gab es im Büro meiner Eltern", translation: "There was in my parents' office"},
        { time: 7, sentence: "eine Wand Regal voller Bücher.", translation: "a wall of shelves full of books."},
        { time: 10, sentence: "In den untersten Reihen", translation: "On the bottom rows"},
        { time: 14.5, sentence: "waren Kinderbücher für uns bereitgestellt.", translation: "children's books were provided for us."},
        { time: 17.5, sentence: "Ich war damals regelrecht besessen", translation: "At that time, I was truly obsessed" },
        { time: 22, sentence: "von Märchenbüchern", translation: "with fairy tale books" },
        { time: 26, sentence: "und zog diese mit Vorliebe aus dem Regal.", translation: "and loved pulling them off the shelf." },
        { time: 29, sentence: "Eins dieser Bücher", translation: "One of these books"},
        { time: 31, sentence: "hielt ich mit voller Überzeugung", translation: "I was fully convinced"},
        { time: 36, sentence: "für magisch.", translation: "was magical."},
        { time: 40, sentence: "Jedes Mal, wenn ich es zurück ins Regal stellte", translation: "Every time I put it back on the shelf"},
        { time: 45, sentence: "und am nächsten Tag wieder danach griff,", translation: "and picked it up again the next day,"},
        { time: 50, sentence: "war es ein neues Märchen.", translation: "it was a new fairy tale."},
        { time: 55, sentence: "Dieser Wechsel setzte sich so lange fort,", translation: "This change continued for so long,"},
        { time: 60, sentence: "bis die Geschichten schließlich rotierten.", translation: "until the stories eventually started rotating."},
        { time: 65, sentence: "Erst später stellte sich heraus,", translation: "It was only later that it turned out,"},
        { time: 70, sentence: "dass meine Mutter die Bücher heimlich austauschte", translation: "that my mother secretly swapped the books"},
        { time: 75, sentence: "und sich dabei köstlich amüsierte.", translation: "and had great fun doing it."},
        { time: 80, sentence: "Während ich fest davon überzeugt war,", translation: "While I was firmly convinced"},
        { time: 85, sentence: "dass ich ein wahrhaft magisches Buch in Händen hielt.", translation: "that I was holding a truly magical book in my hands."},
    ],
